        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <span
            ...
            style={{
              ...
              fontWeight: 800, color: "#a855f7", letterSpacing: "0.15em",
              marginRight: 30, whiteSpace: "nowrap", cursor: "pointer",
          ...
          <nav style={{ display: "flex" }}>
            {navs.map((n) => (
              <button key={n.label} onClick={() => router.push(n.href)} style={{
                ...
                background: "none", height: 46, display: "flex",
                alignItems: "center",
            ...
            <div ref={moreRef} style={{ position: "relative" }}>
              ...
              {showMore && (
                <div style={{
                  ...
                  boxShadow: "0 10px 30px rgba(0,0,0,0.8)", zIndex: 9100,
                }}>
                  {moreNavs.map((item) => (
                    <button
                      key={item.label}
                      ...
                      style={{
                        ...
                        color: path === item.href ? "#fff" : "#9ca3af",
                        letterSpacing: "0.1em",
                        background: path === item.href ? "rgba(168,85,247,0.1)" : "none",
                        border: "none",
                      ...
                      onMouseLeave={(e) => {
                        (e.target as HTMLElement).style.background =
                          path === item.href ? "rgba(168,85,247,0.1)" : "none";
                        (e.target as HTMLElement).style.color =
                          path === item.href ? "#fff" : "#9ca3af";
                      }}
                    >
                      {item.label}
                    </button>
